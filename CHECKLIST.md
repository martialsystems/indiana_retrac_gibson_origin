...
6. Buyer file: one cover paragraph, one table, two figures. Not a git clone. README has no county rows. Sheet lock `c89de5b`. Do not overwrite `delivery/gibson_origin_2024_sheet.pdf`.
